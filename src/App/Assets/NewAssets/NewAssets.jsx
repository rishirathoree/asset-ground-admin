...
const NewAssets = () => {
  ...
  return (
    ...
    <div className='flex lg:items-center md:items-start sm:items-start gap-4 lg:flex-row md:flex-row sm:flex-col justify-between'>
        ...
        <input id='SearchByID' placeholder='Search By Title & ID' type="text" className=' focus:outline-none outline-none text-[12px] text-gray-400 font-normal' />
        </label>

        <div className='flex items-center flex-wrap gap-2'>

        <label htmlFor="filterdate" className='p-3 ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <i className='bx bx-search text-[#D54049]'></i>
        <select id='filterdate' type="text" className='text-[12px] text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-date">Filter by Date</option></select>
        </label>

        <label htmlFor="filtertype" className='p-3 ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <i className='bx bx-search text-[#D54049]'></i>
        <select id='filtertype' type="text" className='text-[12px] text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-date">Filter by Date</option></select>
        </label>

        <label htmlFor="filterPrice" className='p-3 ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <i className='bx bx-search text-[#D54049]'></i>
        <select id='filterPrice' type="text" className='text-[12px] text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-date">Filter by Date</option></select>
        </label>
              ...
              {dummy.map((item, index) => {
                return (
                  <tr
                    ...
                    className="bg-white  "
                  >
                    <td className="p-4 ring-1 ring-black/5 text-black">{Math.floor(index * Math.random() * 99999)}</td>
