...
const Customers = () => {
  ...
  return (
    ...
    <div className='flex lg:items-center md:items-start sm:items-start gap-4 lg:flex-row md:flex-row sm:flex-col justify-between'>
        ...
        <button className='py-2 px-6 text-xsm text-white bg-[rgba(213,64,74,0.7)]'>Export</button>
        </div>
        

        <div className='flex items-center flex-wrap gap-2'>

        <label htmlFor="filternotfication" className=' ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <select id='filternotfication' type="text" className='text-[12px] p-2 text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-notification">Filter by Notifcation</option></select>
        </label>
        ...
        <label htmlFor="filterInterest" className=' ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <select id='filterInterest' type="text" className='text-[12px] p-2 text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-Interest">Filter by Interest</option></select>
        </label>

        <label htmlFor="filterPrice" className=' ring-[#D5404940] bg-none ring-1 bg-white flex items-center gap-2'>
        <select id='filterPrice' type="text" className='text-[12px] p-2 text-gray-400 font-normal focus:outline-none outline-none'><option value="Fiter-by-price">Filter by Price</option></select>
        </label>
    ...
    <div className="relative overflow-x-auto ring-1 ring-black/5 bg-white lg:w-w-full md:w-full sm:w-full h-min">
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase  dark:bg-gray-700 dark:text-gray-400">
              ...
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">First</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Last</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Email</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Type</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Interested In</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Phone</p></th>
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Country</p></th>
              ...
              {dummy.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="p-4 ring-1 ring-black/5 text-black">John</td>
                    <td className="p-4 ring-1 ring-black/5 text-black">George</td>
                    <td className="p-4 ring-1 ring-black/5 text-black">George@gmail.com</td>
                    <td className="p-4 ring-1 ring-black/5 text-black "><p className='w-max'>{index % 2 ? 'Individual' : 'Company'}</p></td>
                    <td className="p-4 ring-1 ring-black/5 text-black "><p className='w-max'>{index % 2 ? 'Buying' : 'Selling'}</p></td>
                    <td className="p-4 ring-1 ring-black/5 text-black"><p className='w-max'>+91877550374</p></td>
                    <td className="p-4 ring-1 ring-black/5 text-black"><p className='w-max'>Czech Republic</p></td>
                    <td className="p-4 ring-1 ring-black/5 w-full flex items-center justify-center"> <Link to="/customeroverview"><span className='cursor-pointer p-2 rounded bg-gray-400/10 ring-2 ring-black/5'>Go</span></Link></td>
                  </tr>
                );
              })}
            </tbody>
