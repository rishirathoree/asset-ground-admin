    ...
    <div className="relative overflow-x-auto ring-1 ring-black/5 bg-white lg:w-w-full md:w-full sm:w-full h-min">
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase  dark:bg-gray-700 dark:text-gray-400">
              ...
              <th className="p-4 text-left ring-1 ring-black/5"><p className="w-max font-medium text-gray-400">Subject</p></th>
              ...
              {dummy.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="p-4 ring-1 ring-black/5 text-black"><p className='w-max'>Lorem ipsum dolor sit amet consectetur.</p></td>
                    <td className="p-4 ring-1 ring-black/5 w-full flex items-center justify-center"> <Link to="/ContactusService"><span className='cursor-pointer p-2 rounded bg-gray-400/10 ring-2 ring-black/5'>Go</span></Link></td>
                  </tr>
                );
              })}
            </tbody>
