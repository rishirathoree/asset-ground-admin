      ...
      <div className="space-y-6">
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
          <div className="grid grid-cols-1 lg:order-1 md:order-1 sm:order-2 p-8 bg-white shadow-custom rounded-lg gap-4">
            ...
            <span className="font-medium text-gray-400 text-sm">Info Source : </span>
            ...
            <label htmlFor="name" className="w-full flex-col  flex gap-2">
              ...
              <textarea
                id="location"
                type="text"
                className="resize-none appearance-none h-40 p-3 focus:ring-[#D5404940] w-full rounded ring-1 ring-black/5 focus:ring-1 duration-500 focus:outline-none outline-none text-[12px] text-gray-400 font-normal"/
              >
            </label>

            <div className="flex items-center gap-2">
            <i className="bx bx-phone text-[rgba(213,64,74,0.7)]"></i>
            ...
            <div class="slect-allchk">
                ...
                <span className="text-sm font-medium text-black">Also, Request a call from our presentative</span>
            </div>
...
export default InfoCenterServices;
