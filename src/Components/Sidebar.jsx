...
const Sidebar = () => {
  ...
  return (
    ...
    <div onClick={()=>{document.body.classList.remove('sidebar-collapse')}} className='sidebar-overlay duration-500 invisible opacity-0 fixed top-0 z-[888] right-0 bg-black bg-opacity-5 w-full h-screen'></div>
      <div className='aside lg:w-1/6 md:w-1/3 sm:w-1/6 lg:visible md:invisible sm:invisible lg:translate-x-0 md:-translate-x-full sm:-translate-x-full duration-500 lg:static md:fixed sm:fixed overflow-hidden overflow-y-auto bg-white'>
